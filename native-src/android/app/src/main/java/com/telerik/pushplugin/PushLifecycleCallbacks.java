...
public class PushLifecycleCallbacks implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityPaused(Activity activity) {
        Log.d(PushPlugin.TAG, "33333333333333onActivityPaused: Application has been stopped.");
    ...
    public void onActivityResumed(Activity activity) {
        Log.d(PushPlugin.TAG, "33333333333333333onActivityResumed: Application has been started");
    ...
    public void onActivityCreated(Activity activity, Bundle bundle) {
        Log.d(PushPlugin.TAG, "onActivityCreated with bundle");
    }

    public void onActivityDestroyed(Activity activity) {
        Log.d(PushPlugin.TAG, "onActivityDestroyed");
    }

    public void onActivitySaveInstanceState(Activity activity,
                                            Bundle outState) {
        Log.d(PushPlugin.TAG, "saving state");
    }

    public void onActivityStarted(Activity activity) {
        Log.d(PushPlugin.TAG, "onActivityStarted: Application has been started");
    }

    public void onActivityStopped(Activity activity) {
        Log.d(PushPlugin.TAG, "onActivityStopped: Application has been stopped");
    }
}